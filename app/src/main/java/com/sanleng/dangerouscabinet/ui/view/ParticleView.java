...
public class ParticleView extends View {
    ...
    public ParticleView(Context context, @Nullable AttributeSet attrs) {
        ...
        count = array.getInt(R.styleable.ParticleView_pv_count, 25);
        alpha = array.getInt(R.styleable.ParticleView_pv_alpha, 60);
        minSize = array.getInt(R.styleable.ParticleView_pv_min_size, 10);
        maxSize = array.getInt(R.styleable.ParticleView_pv_max_size, 20);
