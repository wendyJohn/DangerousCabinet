...
public class PwdEditText extends AppCompatEditText {
    ...
    public PwdEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.PwdEditText);
...
//        pwdLegth = array.getInteger(R.styleable.PwdEditText_length, 0);
        // 初始化密码画笔
        mPwdPaint = new Paint();
        mPwdPaint.setColor(Color.parseColor("#000000"));
        ...
        mRectPaint.setColor(Color.parseColor("#ff666666"));
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        mWidth = getWidth();
        mHeight = getHeight(); // 这三行代码非常关键，大家可以注释点在看看效果
