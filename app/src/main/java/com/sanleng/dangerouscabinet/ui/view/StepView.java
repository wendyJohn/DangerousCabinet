...
public class StepView extends View {
    ...
    private String[] bottomText = {"a","b", "c", "d","e"};
    ...
    public StepView(Context context, @Nullable AttributeSet attrs) {
        ...
        mStepNumberTextSize = t.getDimensionPixelSize(R.styleable.StepView_step_number_text_size, dp2px(context, 20));
        mStepBottomTextSize = t.getDimensionPixelSize(R.styleable.StepView_step_bottom_text_size, dp2px(context, 20));
        mStepTxtMarginTop = t.getDimensionPixelSize(R.styleable.StepView_step_txt_margin_top, dp2px(context, 20));
        mStepCircleRadius = t.getDimensionPixelSize(R.styleable.StepView_step_circle_radius, dp2px(context, 20));
        init();
        t.recycle();
    }
    ...
    private void drawStep(Canvas canvas, int i, int centerX, int startCircleY, int fontHeight, int fontOffset) {
        ...
        mPaint.setStrokeWidth(dp2px(getContext(), 10));
        if (mStepCount > i) {
            mPaint.setColor(mCurrentStep > i ? mStepFinishColor : mStepUnfinishColor);
